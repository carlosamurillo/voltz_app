        ...
        child: Row(
          children: [
            ...
            Expanded(child: Column(
              ...
              children: [
                Text( "Puedes modificar este pedido",
                    style: GoogleFonts.montserrat(color: _white, fontSize: 16, fontWeight: FontWeight.w400)),
                const SizedBox(height: 5,),
                Text( "Abre esta URL desde tu computador de escritorio o portátil para acceder a todas las funcionalidades.",
                    style: GoogleFonts.montserrat(color: _white, fontSize: fontSizeParagraph, fontWeight: FontWeight.w400,)),
              ],
            ),),
          ],
        )
              ...
              child: Column(
                ...
                children: [
                  Row (
                      children: [
                        Text( "Resumen del pedido",
                            style: GoogleFonts.montserrat(color: _volcanic, fontSize: 18, fontWeight: FontWeight.w600,)),
                        const Spacer(),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(" (-${currencyFormat.format(model.quote.totals!.discount!)} dcto.)",
                          style: GoogleFonts.montserrat(color: _blue, fontSize: fontSizeParagraph, fontWeight: FontWeight.w400,)),
                      const Spacer(),
                  ...
                  Row(
                    ...
                    children: [
                      Text('Envio',
                          style: GoogleFonts.montserrat(color: _volcanic, fontSize: fontSizeParagraph, fontWeight: FontWeight.w400,)),
                      const Spacer(),
                      if (model.quote.shipping == null ||
                          model.quote.shipping!.total == 0)...[
                        Text('Gratis',
                            style: GoogleFonts.montserrat(color: _blue, fontSize: fontSizeParagraph, fontWeight: FontWeight.w400,)),
                      ] else
                        ...[
                  ...
                  Row(
                    ...
                    children: [
                      Text('Total pedido',
                          style: GoogleFonts.montserrat(color: _volcanic, fontSize: fontSizeParagraph, fontWeight: FontWeight.w600,)),
                      const Spacer(),
              ...
              Column(
                children: [
                  Text(
                    ...
                    style: GoogleFonts.montserrat(color: _white, fontSize: 24, fontWeight: FontWeight.w600,),
                    maxLines: 3,
                    overflow: TextOverflow.clip,
                  ),
                  Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: GoogleFonts.montserrat(color: _white, fontSize: fontSizeParagraph, fontWeight: FontWeight.w600,),
                        maxLines: 3,
                        overflow: TextOverflow.clip,
                      ),
                      SizedBox(
                  ...
                  children: [
                    Container(
                      ...
                      child:  Text("Transferencia electrónica",
                        style: GoogleFonts.montserrat(color: _volcanic, fontSize: 14, fontWeight: FontWeight.w600,),
                      ),
                    ),
                    Container(
                      margin: const EdgeInsets.all(0),
                ...
                Row(
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.montserrat(color: _volcanic, fontSize: 10, fontWeight: FontWeight.w400,),
                      maxLines: 2,
                      overflow: TextOverflow.clip,
                    ),
                    const Spacer(),
