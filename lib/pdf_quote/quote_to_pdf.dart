...
class QuotePdf {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Spacer(),
                if (quote.shipping == null || quote.shipping!.total == 0) ...[
                  Text('Gratis',
                      style: TextStyle(
                        color: _blue,
                        fontSize: fontSizeParagraph,
  ...
  Future<String?> _uploadFile(Uint8List bytes) async {
    ...
    Reference ref = FirebaseStorage.instance.ref().child('public').child('cotizaciones_pdf').child(quote.customer!.id!).child('cotizacion_voltz_${quote.consecutive}.pdf');

    final metadata = SettableMetadata(
      contentType: 'application/pdf',
      customMetadata: {'por': "Voltz", 'cotización No.': quote.consecutive.toString(), 'id cotización': quote.id!, 'alias': quote.alias!, 'pais': "Mexico"},
    );
    print('linea 10');
    String? url;
    try {
