...
class OrderPdf {
  OrderPdf({required this.order, required this.selectedProducts});
  ...
  void generatePdf() async {
    await Future.wait([_loadFonts(), _loadAssistant(), _loadAmex(), _loadPaypal(), _loadVisa()]);
  ...
  Future<void> _loadAssistant() async {
    _assistantIcon = await p
        .networkImage('https://firebasestorage.googleapis.com/v0/b/voltz-pro.appspot.com/o/public%2Fassistant_icon.png?alt=media&token=a38ac3f8-0ab3-4558-a77d-831ea14852fb');
  }

  Future<void> _loadAmex() async {
    _amex_image =
        await p.networkImage('https://firebasestorage.googleapis.com/v0/b/voltz-pro.appspot.com/o/public%2FAmex.png?alt=media&token=d997de8b-412d-429f-9086-aa0f66335285');
  }

  Future<void> _loadPaypal() async {
    _paypal_image =
        await p.networkImage('https://firebasestorage.googleapis.com/v0/b/voltz-pro.appspot.com/o/public%2FPaypal.png?alt=media&token=02dfcd64-7467-4b1a-b437-427f5b091590');
  }

  Future<void> _loadVisa() async {
    _visa_image =
        await p.networkImage('https://firebasestorage.googleapis.com/v0/b/voltz-pro.appspot.com/o/public%2FVisamaster.png?alt=media&token=32df52e8-9c33-4b3c-af4f-c36887d5c3de');
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Spacer(),
          Column(children: [
            Text("Versión impresa", style: TextStyle(fontSize: fontSizeParagraph, font: _fontSemiBold, color: _volcanic)),
            UrlLink(
                child: Text("Usar versión digital", style: TextStyle(fontSize: 10, font: _fontRegular, color: _blue, decoration: TextDecoration.underline)),
                destination: "${_config.appUrl}?cotz=${order.id!}"),
          ])
        ],
      ),
    );
  ...
  Container _summary(OrderModel order) {
    return Container(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(" (-${currencyFormat.format(order.totals!.discount!)} dcto.)",
                    style: TextStyle(
                      color: _blue,
                      fontSize: fontSizeParagraph,
                      font: _fontRegular,
                ...
                Spacer(),
                Text(currencyFormat.format(order.totals!.subTotal! - order.totals!.discount!),
                    style: TextStyle(
                      color: _volcanic,
                      fontSize: fontSizeParagraph,
                      font: _fontRegular,
            ...
            Row(
              ...
              children: [
                ...
                Spacer(),
                Text(currencyFormat.format(order.totals!.tax!),
                    style: TextStyle(
                      color: _volcanic,
                      fontSize: fontSizeParagraph,
                      font: _fontRegular,
            ...
            Row(
              ...
              children: [
                ...
                Spacer(),
                if (order.shipping == null || order.shipping!.total == 0) ...[
                  Text('Gratis',
                      style: TextStyle(
                        color: _blue,
                        fontSize: fontSizeParagraph,
                  ...
                  Text(currencyFormat.format(order.shipping!.total!),
                      style: TextStyle(
                        color: _volcanic,
                        fontSize: fontSizeParagraph,
                        font: _fontRegular,
            ...
            Row(
              ...
              children: [
                ...
                Spacer(),
                Text('${currencyFormat.format(order.totals!.total)} MXN',
                    style: TextStyle(
                      color: _volcanic,
                      fontSize: fontSizeParagraph,
                      font: _fontSemiBold,
  ...
  Container _addSavings(OrderModel order) {
    return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: 5),
            Text(
              currencyFormat.format(order.totals!.saving),
              style: TextStyle(
                color: _volcanic,
                fontSize: 13,
                font: _fontRegular,
  ...
  Container _detailFirstPage(OrderModel order) {
    return Container(
      child: Column(
        children: [
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                //TODO poder ver los productos incluidos aqui
                // Padding(
                //   padding: const EdgeInsets.symmetric(horizontal: 20),
                //   child: Text(
                //     "${order.detail!.length} Productos incluidos",
                //     style: TextStyle(
                //       color: _volcanic,
                //       fontSize: 18,
                //       font: _fontSemiBold,
          ...
          Row(
            children: [
              ...
              Text(
                ...
                style: TextStyle(color: _volcanic, fontSize: fontSizeParagraph, font: _fontRegular, decoration: TextDecoration.lineThrough),
                maxLines: 1,
                overflow: TextOverflow.clip,
              ),
              SizedBox(width: 5),
  ...
  Future<String?> _uploadFile(Uint8List bytes) async {
    ...
    Reference ref = FirebaseStorage.instance.ref().child('public').child('cotizaciones_pdf').child(order.customer!.id!).child('pedido_voltz_${order.consecutive}.pdf');

    final metadata = SettableMetadata(
      contentType: 'application/pdf',
      customMetadata: {'por': "Voltz", 'cotización No.': order.consecutive.toString(), 'id pedido': order.id!, 'alias': order.alias!, 'pais': "Mexico"},
    );
    print('linea 10');
    String? url;
    try {
