              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 72,
                      child: _QuantityWidget(i: widget.i, b: 0, listenerUpdateTotals: _updateTotals),
                    )
                  ],
                ),
              ),
        ...
        children: [
          Expanded(child: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "${currencyFormat.format(widget.totalProducts)} productos",
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child:  Row(
                                  ...
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    Text('Hacer pedido', style: CustomStyles.styleVolcanicUno,)
                                  ],
                                ),
                              ),
                            ),
